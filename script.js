...
const translations = {
    ...
    id: { 
        ...
        japaneseCategory: "Masakan Jepang", // カテゴリ名追加
        indonesianCategory: "Masakan Indonesia", // カテゴリ名追加
        sweetsCategory: "Makanan Penutup", // カテゴリ名追加
        drinksCategory: "Minuman" // カテゴリ名追加
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateLanguage(lang) {
        ...
        dom.menuButtons.forEach(button => {
            const categoryKey = button.dataset.key; // HTMLで data-key="japaneseCategory" などと設定
            if (translations[lang][categoryKey]) {
